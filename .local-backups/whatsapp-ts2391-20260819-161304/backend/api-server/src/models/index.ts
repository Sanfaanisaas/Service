...
const receiptDeliverySchema = new Schema({
  receiptId: {
...
receiptDeliverySchema.index(
    { receiptId: 1, channel: 1 },
    { unique: true },
);
...
export const ReceiptDelivery =
    mongoose.model('ReceiptDelivery', receiptDeliverySchema);
